...
| asset_kind  | 1..1        | [Code](./code) | A valid [Asset Kind](/docs/spec/code_system/asset_kind) code which identifies the specific kind of PIES message data type this message represents.                                                        |
