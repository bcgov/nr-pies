...
id: header
title: Header
description: Standard header attributes present for all PIES message data types
tags:
  - developer
---
...
import example from "@site/docs/spec/message/header.example.json";
import schema from "@site/docs/spec/message/header.schema.json";
...
All header attributes are considered mandatory. A valid PIES message datagram must define all of the header attributes.
