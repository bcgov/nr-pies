...
| Stage                        | Description                                                                                                                                                                                                                                                                                                                               |
| ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Pre-application              | The proponent prepares on the application in the intake channel. No formal submission or review is underway; the file remains entirely with the proponent.                                                                                                                                                                                |
