...
| Decision review start date            | The date and time when the reviews, referrals and consultation has been starts.                                                                                 |
...
| Adjudication date                     | The date and time when the application is adjudicated, and a final decision is made. This date also be the same day it was issued.                              |
