...
Phase is a business-level category of engagement with an authorization. It distinguishes whether the record is still being created and assessed e.g., **Application** or is already in effect and being managed e.g., **Post-issuance**. It defines the **why** part of work on the authorization, not process categories of work, see Stages below.
