---
id: ADR_005
title: ADR-005 - Asset Kind Enumeration
...
- [ADR-004](./ADR_004) establishes `asset_kind` as the field name.
- [ADR-003](./ADR_003) defines the structure that carries `asset_kind`.
